...
import com.tutorial.hazelcastpoc.dao.IEmployeeDAO;
 ...
 * @author Ana
 */
@WebServlet("/HazelcastCacheServlet")
public class HazelcastCacheServlet extends HttpServlet {
   private static Logger logger = Logger.getLogger(HazelcastCacheServlet.class);
